...
// WebGL2 translation of advanced/gaussian_horizontal.slang
// libretro/slang-shaders @ a62d9cda9140294d22b6da5e4ff4187365890d42
// Source SHA-256: 31c3999ac5b0f6dd784039a22ab3da3c56cd2141eeaedf7b3821c831556e9e53
...
void main()
{
    ...
    {
        _34 = uParams_FINE_GLOW;
    }
    else
    {
        _34 = mix(0.75, 0.5, -uParams_FINE_GLOW);
    }
    FINE_GLOW = _34;
    invsqrsigma = 1.0 / ((2.0 * uParams_SIGMA_H) * uParams_SIGMA_H);
