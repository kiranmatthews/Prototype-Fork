...
// WebGL2 translation of advanced/pre-shaders-afterglow.slang
// libretro/slang-shaders @ a62d9cda9140294d22b6da5e4ff4187365890d42
// Source SHA-256: 1c4e57ff95acc881d761d95196fce8e3000701750868187907c4cffad5c6d4b7
...
void main()
{
    ...
    bvec3 _779 = bvec3(uParams_wp_saturation > 1.0);
    color = vec3(_779.x ? scolor1.x : scolor2.x, _779.y ? scolor1.y : scolor2.y, _779.z ? scolor1.z : scolor2.z);
    ...
    bvec3 _852 = bvec3(uParams_WP < 0.0);
    highp vec3 comp = vec3(_852.x ? cooler.x : warmer.x, _852.y ? cooler.y : warmer.y, _852.z ? cooler.z : warmer.z);
    ...
    highp float _926 = vignette(param_8);
    FragColor = vec4(color, _926);
}
