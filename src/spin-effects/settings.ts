...
const groundedSkateOverrides: readonly Readonly<SpinRingOverride>[] = [
  { heightOffset: -0.047, radiusScale: 0.7150872945785522, lineColorA: 16774313, lineColorB: 16772017, glowColorA: 16747264, glowColorB: 16751872, colorPulsePhase: 0 },
  { heightOffset: -0.188, radiusScale: 1.011, lineColorA: 16777215, lineColorB: 16748888, glowColorA: 16740869, glowColorB: 16750342, colorPulsePhase: 0 },
  { heightOffset: 0.5931559801101685, radiusScale: 1.5776262283325195, lineColorA: 16760396, lineColorB: 16741492, glowColorA: 16731136, glowColorB: 16739584, colorPulsePhase: 0 },
  { heightOffset: 0.49090576171875, radiusScale: 1.229990005493164, lineColorA: 15177727, lineColorB: 9598719, glowColorA: 8915711, glowColorB: 10223871, colorPulsePhase: 0 },
  { heightOffset: -0.668890118598938, radiusScale: 0.6939601302146912, lineColorA: 12550143, lineColorB: 10119423, glowColorA: 12779775, glowColorB: 5570815, colorPulsePhase: 0 },
  { heightOffset: -1, radiusScale: 0.5, lineColorA: 10524335, lineColorB: 8359573, glowColorA: 8026746, glowColorB: 5066061, colorPulsePhase: 0 },
  { heightOffset: 0, radiusScale: 1, lineColorA: 16773594, lineColorB: 14218495, glowColorA: 16736864, glowColorB: 6721023, colorPulsePhase: 0 },
...
/** User-tuned two-ring treatment for spins begun while skating on ground. */
export const DEFAULT_GROUNDED_SKATE_SPIN_RING_SETTINGS: Readonly<SpinRingSettingsValue> =
  Object.freeze({
    ...
    radiusScale: 1.284499168395996,
    verticalSpread: 0,
    minimumTiltDegrees: 1.63,
    maximumTiltDegrees: 7.99,
    selfSpinRadiansPerSecond: 7.508416652679443,
    ringInner: 0.65,
    ringOuter: 0.9500410556793213,
    ringLine: 0.04011207073926926,
    ...
    ringBright: 4,
    alpha: 1,
    vary: 0.22602605819702148,
    sharedLow: 0.00800000037997961,
    sharedLowRate: 0,
    sharedMid: 0.018647870048880577,
    sharedMidRate: 1.1208343505859375,
    breathe: 0.007108653429895639,
    breatheRate: 0,
    wavyAmp: 0.0036084987223148346,
    wavyFreq: 2.5489373207092285,
    wavyRate: 0.82025146484375,
    jagAmp: 0,
    jagFreq: 4.44208288192749,
    jagRate: -1.7192716598510742,
    depth: 2,
    spin: 0,
    spinDiff: 0,
    swallow: 0,
    swallowTo: 0.01,
    swallowFrom: 1.0097004175186157,
    current: 0,
    currentRate: 0,
    pulse: 1.3020074367523193,
    pulseRate: 16,
    lineColor: 16773594,
    glowColor: 16736864,
    coolLineColor: 14218495,
