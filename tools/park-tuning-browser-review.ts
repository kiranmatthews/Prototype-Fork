...
import {SKATE_PARK} from '../src/skateParkPhysics';
...
const initialDebug=document.body.classList.contains('game-debug-visible');
function debugView(visible:boolean){document.body.classList.toggle('game-debug-visible',visible);document.body.classList.toggle('game-debug-hidden',!visible);}
debugView(false);
