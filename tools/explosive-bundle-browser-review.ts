...
for(const [label,clock]of[['Minimum Nitro',.825],['Maximum Nitro',.275]] as const)add(label,()=>{paused=true;level.time=clock;level.update(0);selected=nitro;compare=false;});
