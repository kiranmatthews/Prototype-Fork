#!/usr/bin/env node
/** Convert the owner-supplied BoolieRoo Meshy head FBX into browser geometry. */
...
function moduleSource(asset) {
  return `// Generated by tools/import-meshy-boolieroo-head.mjs. Do not hand-edit.\n` +
    `// Owner-supplied Meshy BoolieRoo alternate-head evaluation asset.\n\n` +
    `export const MESHY_BOOLIEROO_HEAD_ASSET = Object.freeze(${JSON.stringify(asset, null, 2)} as const);\n`;
}
