...
button('Revert',()=>start('revert'));button('Flat Kickflip',()=>{flip.value='Kickflip';start('flat-flip');});button('Flat Heelflip',()=>{flip.value='Heelflip';start('flat-flip');});button('Flat Pop Shove-It',()=>{flip.value='Pop Shove-It';start('flat-flip');});button('Flat Impossible',()=>{flip.value='Impossible';start('flat-flip');});button('Flat Varial Kickflip',()=>{flip.value='Varial Kickflip';start('flat-flip');});button('Flat Varial Heelflip',()=>{flip.value='Varial Heelflip';start('flat-flip');});button('Flat Hardflip',()=>{flip.value='Hardflip';start('flat-flip');});
