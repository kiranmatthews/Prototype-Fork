...
- Menu focus uses lettering alone: the current item alternates orange and bright white every 450 ms, while other action labels stay shaded brown-tan. Do not add focus arrows, row/background highlights, outlines or glow. Preserve ordinary disabled/locked states and navigation controls. Reduced motion holds orange. This is a reversible runtime layer; its comparison switch belongs in the M-dismissible Text Tuning panel.
