...
Full-suite audit (2026-09-11): all 42 check groups passed after correcting stale headless-DOM, animation-catalog and menu-rendering test expectations. Nitro remains stationary and its eased glow never drops below the charged baseline.
